 ...
 */
public class AOTRawScriptInfo$Lock extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$Lock () {
        FoundationClassParser parser = new FoundationClassParser("System/Concurrency/Lock.jul");
        ainfo = new LazyAstInfo(parser, "System/Concurrency/Lock.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("Lock", new AOTClassDeclInfo_Lock (this)));
    ...
    public String getScriptFilePath() {
        return "System/Concurrency/Lock.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_Lock extends LazyClassDeclInfo {

        public AOTClassDeclInfo_Lock(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Concurrency.Lock");
