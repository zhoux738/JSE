...
public class AOTRawScriptInfo$Exception extends RawScriptInfo {
    ...
    public AOTRawScriptInfo$Exception () {
        FoundationClassParser parser = new FoundationClassParser("System/IO/Exception.jul");
        ainfo = new LazyAstInfo(parser, "System/IO/Exception.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("IOException", new AOTClassDeclInfo_IOException (this)));
    ...
    public String getScriptFilePath() {
        return "System/IO/Exception.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_IOException extends LazyClassDeclInfo {

        public AOTClassDeclInfo_IOException(RawScriptInfo minfo) {
            super(minfo);
        ...
        private FQName m_fullName = new FQName("System.IO.IOException");
