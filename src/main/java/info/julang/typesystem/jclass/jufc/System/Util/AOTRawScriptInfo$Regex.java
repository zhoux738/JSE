 ...
 */
public class AOTRawScriptInfo$Regex extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$Regex () {
        FoundationClassParser parser = new FoundationClassParser("System/Util/Regex.jul");
        ainfo = new LazyAstInfo(parser, "System/Util/Regex.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("Regex", new AOTClassDeclInfo_Regex (this)));
        m_classes.add(new RawClassInfo("Match", new AOTClassDeclInfo_Match (this)));
    ...
    public String getScriptFilePath() {
        return "System/Util/Regex.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_Regex extends LazyClassDeclInfo {

        public AOTClassDeclInfo_Regex(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Util.Regex");
    ...
    class AOTClassDeclInfo_Match extends LazyClassDeclInfo {

        public AOTClassDeclInfo_Match(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Util.Match");
