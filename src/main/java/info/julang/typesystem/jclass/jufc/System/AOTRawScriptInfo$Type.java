 ...
 */
public class AOTRawScriptInfo$Type extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$Type () {
        FoundationClassParser parser = new FoundationClassParser("System/Type.jul");
        ainfo = new LazyAstInfo(parser, "System/Type.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("Type", new AOTClassDeclInfo_Type (this)));
    ...
    public String getScriptFilePath() {
        return "System/Type.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_Type extends LazyClassDeclInfo {

        public AOTClassDeclInfo_Type(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Type");
