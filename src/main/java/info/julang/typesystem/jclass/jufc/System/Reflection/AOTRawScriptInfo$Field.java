 ...
 */
public class AOTRawScriptInfo$Field extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$Field () {
        FoundationClassParser parser = new FoundationClassParser("System/Reflection/Field.jul");
        ainfo = new LazyAstInfo(parser, "System/Reflection/Field.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("Field", new AOTClassDeclInfo_Field (this)));
    ...
    public String getScriptFilePath() {
        return "System/Reflection/Field.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_Field extends LazyClassDeclInfo {

        public AOTClassDeclInfo_Field(RawScriptInfo minfo) {
            super(minfo);
        ...
        private FQName m_fullName = new FQName("System.Reflection.Field");
