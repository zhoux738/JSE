 ...
 */
public class AOTRawScriptInfo$TextReader extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$TextReader () {
        FoundationClassParser parser = new FoundationClassParser("System/IO/TextReader.jul");
        ainfo = new LazyAstInfo(parser, "System/IO/TextReader.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("TextReader", new AOTClassDeclInfo_TextReader (this)));
    ...
    public String getScriptFilePath() {
        return "System/IO/TextReader.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_TextReader extends LazyClassDeclInfo {

        public AOTClassDeclInfo_TextReader(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.IO.TextReader");
