 ...
 */
public class AOTRawScriptInfo$Thread extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$Thread () {
        FoundationClassParser parser = new FoundationClassParser("System/Concurrency/Thread.jul");
        ainfo = new LazyAstInfo(parser, "System/Concurrency/Thread.jul", null);
    ...
    public String getScriptFilePath() {
        return "System/Concurrency/Thread.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_ThreadPriority extends LazyClassDeclInfo {

        public AOTClassDeclInfo_ThreadPriority(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Concurrency.ThreadPriority");
    ...
    class AOTClassDeclInfo_ThreadState extends LazyClassDeclInfo {

        public AOTClassDeclInfo_ThreadState(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Concurrency.ThreadState");
    ...
    class AOTClassDeclInfo_Thread extends LazyClassDeclInfo {

        public AOTClassDeclInfo_Thread(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Concurrency.Thread");
