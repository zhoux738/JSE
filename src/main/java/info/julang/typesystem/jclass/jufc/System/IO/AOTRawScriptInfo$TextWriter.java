 ...
 */
public class AOTRawScriptInfo$TextWriter extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$TextWriter () {
        FoundationClassParser parser = new FoundationClassParser("System/IO/TextWriter.jul");
        ainfo = new LazyAstInfo(parser, "System/IO/TextWriter.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("TextWriter", new AOTClassDeclInfo_TextWriter (this)));
    ...
    public String getScriptFilePath() {
        return "System/IO/TextWriter.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_TextWriter extends LazyClassDeclInfo {

        public AOTClassDeclInfo_TextWriter(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.IO.TextWriter");
