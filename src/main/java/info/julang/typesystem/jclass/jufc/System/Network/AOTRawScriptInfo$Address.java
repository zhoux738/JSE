 ...
 */
public class AOTRawScriptInfo$Address extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$Address () {
        FoundationClassParser parser = new FoundationClassParser("System/Network/Address.jul");
        ainfo = new LazyAstInfo(parser, "System/Network/Address.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("AddressType", new AOTClassDeclInfo_AddressType (this)));
        m_classes.add(new RawClassInfo("NetAddress", new AOTClassDeclInfo_NetAddress (this)));
    ...
    public String getScriptFilePath() {
        return "System/Network/Address.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_AddressType extends LazyClassDeclInfo {

        public AOTClassDeclInfo_AddressType(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Network.AddressType");
    ...
    class AOTClassDeclInfo_NetAddress extends LazyClassDeclInfo {

        public AOTClassDeclInfo_NetAddress(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.Network.NetAddress");
