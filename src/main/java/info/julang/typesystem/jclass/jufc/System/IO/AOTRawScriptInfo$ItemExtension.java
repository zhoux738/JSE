 ...
 */
public class AOTRawScriptInfo$ItemExtension extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$ItemExtension () {
        FoundationClassParser parser = new FoundationClassParser("System/IO/ItemExtension.jul");
        ainfo = new LazyAstInfo(parser, "System/IO/ItemExtension.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("ItemExtension", new AOTClassDeclInfo_ItemExtension (this)));
    ...
    public String getScriptFilePath() {
        return "System/IO/ItemExtension.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_ItemExtension extends LazyClassDeclInfo {

        public AOTClassDeclInfo_ItemExtension(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.IO.ItemExtension");
