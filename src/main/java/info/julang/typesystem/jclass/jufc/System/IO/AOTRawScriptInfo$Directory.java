 ...
 */
public class AOTRawScriptInfo$Directory extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$Directory () {
        FoundationClassParser parser = new FoundationClassParser("System/IO/Directory.jul");
        ainfo = new LazyAstInfo(parser, "System/IO/Directory.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("Directory", new AOTClassDeclInfo_Directory (this)));
    ...
    public String getScriptFilePath() {
        return "System/IO/Directory.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_Directory extends LazyClassDeclInfo {

        public AOTClassDeclInfo_Directory(RawScriptInfo minfo) {
            super(minfo);
        ...
        private FQName m_fullName = new FQName("System.IO.Directory");
