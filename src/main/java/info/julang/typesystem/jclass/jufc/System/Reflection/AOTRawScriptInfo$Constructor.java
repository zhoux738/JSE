 ...
 */
public class AOTRawScriptInfo$Constructor extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$Constructor () {
        FoundationClassParser parser = new FoundationClassParser("System/Reflection/Constructor.jul");
        ainfo = new LazyAstInfo(parser, "System/Reflection/Constructor.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("Constructor", new AOTClassDeclInfo_Constructor (this)));
    ...
    public String getScriptFilePath() {
        return "System/Reflection/Constructor.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_Constructor extends LazyClassDeclInfo {

        public AOTClassDeclInfo_Constructor(RawScriptInfo minfo) {
            super(minfo);
        ...
        private FQName m_fullName = new FQName("System.Reflection.Constructor");
