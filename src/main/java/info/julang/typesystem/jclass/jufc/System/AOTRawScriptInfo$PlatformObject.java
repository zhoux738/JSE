 ...
 */
public class AOTRawScriptInfo$PlatformObject extends RawScriptInfo {
    
    private List<RequirementInfo> m_requirements;
    private List<RawClassInfo> m_classes;
    
    public AOTRawScriptInfo$PlatformObject () {
        FoundationClassParser parser = new FoundationClassParser("System/PlatformObject.jul");
        ainfo = new LazyAstInfo(parser, "System/PlatformObject.jul", null);
        
        m_classes = new ArrayList<RawClassInfo>();
        m_classes.add(new RawClassInfo("PlatformObject", new AOTClassDeclInfo_PlatformObject (this)));
    ...
    public String getScriptFilePath() {
        return "System/PlatformObject.jul";
    }
    
    // Types declared in this script //
    
        
    class AOTClassDeclInfo_PlatformObject extends LazyClassDeclInfo {

        public AOTClassDeclInfo_PlatformObject(RawScriptInfo minfo) {
            super(minfo);
            
        }

        private List<ParsedTypeName> m_parentNames = new ArrayList<ParsedTypeName>();
        private FQName m_fullName = new FQName("System.PlatformObject");
